...
const SimpleMarkdown = ({ children }) => {
  ...
  const formatText = (text) => {
    return text
      ...
      .replace(/`(.*?)`/g, '<code class="bg-richblack-600 px-1 rounded">$1</code>') // Code
  ...
  const withLists = formattedText.replace(/(<li>.*<\/li>)/gs, '<ul class="list-disc list-inside mb-4 space-y-1">$1</ul>')
  
  return (
    <div 
      className="prose prose-invert max-w-none"
      dangerouslySetInnerHTML={{ 
        __html: `<p class="mb-4">${withLists}</p>` 
      }} 
    />
  )
}
        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            <div className="relative block max-h-[30rem] lg:hidden">
              ...
              <img src={thumbnail || "/placeholder.svg"} alt="course thumbnail" className="aspect-auto w-full" />
            </div>
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          <div className="my-8 border border-richblack-600 p-8">
            ...
            <div className="mt-5">
              <SimpleMarkdown>{whatYouWillLearn}</SimpleMarkdown>
            </div>
          </div>
